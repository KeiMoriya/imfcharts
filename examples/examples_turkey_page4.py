...
# Create Chart object
dict_attrs = {linecol : {'linewidth' : 4, 'color' : IMFBLACK},
...
dict_attrs = {'Primary revenue' : {'color' : IMFBLUE},
...
dict_attrs = {barcol : {'color' : '#CAEDFE'},
